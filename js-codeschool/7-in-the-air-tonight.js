const checkAir = function (samples, threshold) {
    ...
    // The first argument is an array of strings, where each string represents a
    // small air sample that is either clean or dirty.
    // The second argument is a number representing the highest acceptable
    // amount of dirty samples.
    // For example, a threshold of 0.4 means that there must be less than
    // 40% of total samples classified as dirty for our air to be considered clean.
