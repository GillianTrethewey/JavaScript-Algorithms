// Given an object as an argument that has a list of students
// with their respective list of grades,
// determine which test was the hardest (had the lowest class average).
// INPUT:
// grades: {
